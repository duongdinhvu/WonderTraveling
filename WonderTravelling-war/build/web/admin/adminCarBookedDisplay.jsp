                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Car Booked List</li>
                        </ul><!-- /.breadcrumb -->
                    </div>	
                    ...
                    <div class="container" style="width: 1300px;">
                        <table id="myTable" class="table table-striped table-bordered table-hover" style="width: 1300px;">  
                            <thead>  
                                <tr>                                           
                                    <th  style="width: 320px;">Customer Full Name</th>

                                    <th  style="width: 180px;">Book ID</th>

                                    <th>Car Name</th>
                                    <th>Car Quantities</th>


                                    <th>Car Receive Date</th>
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${requestScope.carBk}" var="car" varStatus="stt">

                                    <tr align="center">

                                        <td style="font-weight: bold">${car.customerID.fullName}</td>



                                        <td style="font-weight: bold">${car.carBookedID}</td>  

                                        <td>${car.carID.carName}</td>
                                        <td>${car.quantity}</td>


                                        <td><fmt:formatDate pattern="dd-MM-yyyy" value="${car.carRecieveDate}" /></td>

                                        <td><fmt:formatDate pattern="dd-MM-yyyy" value="${car.carReturnCaDate}" /></td>

                                        <td><fmt:formatDate pattern="dd-MM-yyyy" value="${car.carRealityDate}" /></td>
                                        ...
                                        <td>${car.extra}$</td> 
                                        <td>${car.price+car.extra}$</td> 

                                        <c:if test="${car.payment == '1'}"><td>Direct</td></c:if>
                                        <c:if test="${car.payment == '2'}"><td>Credit Card</td></c:if>




                                        <c:if test="${car.carBookedStatus == '1'}"><td><span class="label label-white middle">Pending</span></td></c:if>
                                        <c:if test="${car.carBookedStatus == '2'}"><td><span class="label label-success label-white middle">Approved</span></td></c:if>
                                        <c:if test="${car.carBookedStatus == '3'}"><td><span class="label label-warning label-white middle">Returned</span></td></c:if>
                                        <c:if test="${car.carBookedStatus == '4'}"><td><span class="label label-danger label-white middle">Canceled</span></td></c:if>                                         


                                            <td>

                                                <div class="inline pos-rel">                                                     
                                                    <form action="adminCarBookedEditController" method="post">
                                                        <input type="hidden" name="carBookedID" value="${car.carBookedID}"/>
                                ...
                                "drawCallback": function(settings) {
                                    ...
                                    api.column(2, {page: 'current'}).data().each(function(group, i) {
                                        ...
                                        if (last !== group) {
                                            ...
                                            $(rows).eq(i).before(
                                                    '<tr class="group"><td colspan="11">' + group + " - " + rowData[1] + '</td></tr>'
                                                    );
                                            last = group;
