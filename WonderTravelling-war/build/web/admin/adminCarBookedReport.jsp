                        ...
                        <div style="background-color: #ffffff; width: 800px; border-top: #006dcc double">
                            ...
                            <form action="AdminTour_TourReport_Controller" method="post">
                                <div style="margin-left: 5px; margin-top: 20px">
                                    ...
                                    <input id="datepickerFrom" name="txtDateFrom" style="width: 300px; margin-bottom: 10px; margin-top: 5px; padding: 5px;"/><br/>

                                    <b style="font-weight: bold; width: 100px;">Date To</b><br/>
                                    <input id="datepickerTo" name="txtDateTo" style="width: 300px; margin-top: 5px; padding: 5px;"/><br/><br/>
                                ...
                                <div style="background-color: #ffffff; width: 800px;">
                                    <button type="submit" name="action" value="btnViewReport" class="btn-info" style="width: 120px; height: 40px; margin-left: 630px; margin-top: 10px; margin-bottom: 10px;">View Report</button>
                                </div>
                            </form>
                        </div>
                    </div>
