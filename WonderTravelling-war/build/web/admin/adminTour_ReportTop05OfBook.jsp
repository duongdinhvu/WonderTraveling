                    ...
                    <div style="width: 1025px;">
                        ...
                        <div>
                            <center>
                                <table class="table-striped table-hover">
                                    ...
                                    <th style="width: 120px; text-align: center; height: 35px;">Number Of Booked</th>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${requestScope.list}" var="tour" varStatus="num">
                                            <tr style="height: 30px;">
                                                ...
                                                <td style="width: 120px; text-align: center;">${tour.numOfbooked}</td>
                                            </tr>
                                        </c:forEach>
                                        <tr>
                                    ...
                                    <center>
                                        ...
                                        <span style="font-weight: bold; font-size: 15px;">${requestScope.sum}</span>
                                    </center>
                                    </td>
                                    </tr>
                                    </tbody>
                        ...
                        <div style=" margin-left: 20px; margin-top: 100px;">
                            <form action="AdminTour_ReportTour_FilePDF_Controller" method="get">
                                ...
                                <button name="action" value="btnPrintTop05OfBooked" type="submit" style="margin-left: 900px; width: 100px; height: 25px; color: #ffffff;" class="btn-info">Print</button>
                            </form>
                        </div>
                    </div>
                    <!------------------------------------------------ PAGE CONTENT ENDS ---------------------------------------------->
