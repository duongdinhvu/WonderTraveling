        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <!------------------------------------------------ PAGE CONTENT BEGINS ------------------------------------------->
                    <div style="width: 1025px; height: 500px;" id="printPDF">
                        <div style="margin-left: 5px; margin-top: 15px;">
                            <input style="width: 300px; height: 60px;" type="image" src="assets/images/logo.png"/><br/>
                            <p style="font-weight: bold; margin-left: 10px;">Address: 590 CMT8 - District 3 - Ho Chi Minh City</p>
                            <p style="font-weight: bold; margin-left: 10px;">Contact: 01635 250 135 Mr.Dieu Van Toan</p>
                        </div>
                        <div style="font-style: oblique; margin-bottom: 50px; margin-left: 100px;">
                            <center>
                                <h3>TOP 5 OF TOUR REVENUE</h3>
                            </center>
                        </div>
                        <div style="margin-left: 100px;">
                            <center>
                                <label style="font-weight: bold;"><u>From: ${requestScope.dateFromString}</u></label>
                                <label style="margin-left: 100px; font-weight: bold;"><u>To: ${requestScope.dateToString}</u></label>                            
                            </center>
                        </div>
                        <div style="width: 1150px;">
                            <center>
                                <table class="table-striped table-hover">
                                    ...
                                    <th style="width: 120px; text-align: center; height: 35px;">Tour ID</th>
                                    <th style="width: 300px; text-align: center; height: 35px;">Tour Name</th>
                                    <th style="width: 120px; text-align: center; height: 35px;">Revenue</th>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${requestScope.list}" var="tour" varStatus="num">
                                            <tr style="height: 30px;">
                                                <td style="width: 50px; text-align: center;">${num.count}</td>
                                                <td style="width: 120px; text-align: center;">${tour.tourID}</td>
                                                <td style="width: 300px; text-align: center;">${tour.tourtitle}</td>
                                                <td style="width: 120px; text-align: center;">${tour.revenue} USD</td>
                                            </tr>
                                        </c:forEach>
                                        <tr>
                                            <td colspan="4" style="margin-top: 50px;">
                                    <center>
                                        <span style=" margin-left: 330px; margin-right: 80px; font-weight: bold; font-size: 15px;">Total : </span>
                                        <span style="font-weight: bold; font-size: 15px;">${requestScope.sum} USD</span>
                                    </center>
                                    </td>
                                    </tr>
                                    </tbody>
                    ...
                    <div style="width: 1025px;">
                        <div style="margin-left: 20px;">
                            ...
                            <form action="AdminTour_ReportTour_FilePDF_Controller" method="get">
