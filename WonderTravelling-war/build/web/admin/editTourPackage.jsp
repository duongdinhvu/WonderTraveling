                            ...
                            if (subPrice.replace(/^\s+/g, '').length === 0) {
                                ...
                                if (!cbBus && !cbAirPlane) {
                                    ...
                                    if (ticket.replace(/^\s+/g, '').length === 0) {
                                        ...
                                        status = false;
                                        return false;
                                    } else if (ticketInt > 100 || ticketInt < 20) {
                                        document.getElementById('availableTicketError').innerHTML
                            ...
                            <form action="AdminTour_Tour_Update_Controller" method="post" name="formEditTourPackage" onsubmit="return validateForm()">
                                ...
                                <table class="table table-striped table-hover" style="width: 1000px;">
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input style="width: 550px;" id="txtTourTitle_Update" name="txtTourTitle_Update" type="text" value="${requestScope.tour.tourTitle}"/> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label style="width: 150px;">Odd Tour Price:</label>&nbsp;<br/>
                                        </td>
                                        <td>
                                            <input style="width: 150px;" name="txtOddTourPrice_Update" id="txtOddTourPrice_Update" type="number" min="51" max="2000" value="${requestScope.tour.oddTourPrice}"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <input style="width: 150px; text-align: center;" name="txtTickets_Update" id="txtTickets_Update" type="number" min="1" max="100" value="${requestScope.tour.tickets}"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button style="margin-left: 10px; width: 50px;" class="btn-app" id="btnUpdateDepartureDays" type="button"><i class="fa fa-plus-circle"></i></button>
                                            <br/><span id="departuredateError" style="color: red; margin-left: 190px;"></span>
                                            <br/><br/>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <div style="margin-left: 225px; margin-top: 20px;">
                                    <button style="width: 100px; font-size: 14px;" class="btn-success" type="submit" name="action" value="btnDone" onclick="return isValid();">Done</button>

                                    <button style="margin-left: 150px; margin-top: 20px; font-size: 14px;" name="action" value="btnUpdateSchedule" type="submit" class="btn-info">
                                        <i class="fa fa-pencil-square-o"> Edit Schedule</i>
                                    </button>
                                </div>
                            </form>
                            <div>
                                <form action="AdminTour_Tour_Update_Controller" method="post">
                                    <input type="hidden" name="txtTourID_Update" value="${requestScope.tour.tourID}"/>
                                    <button style=" width: 100px; font-size: 14px;" class="btn-default" type="submit" name="action" value="btnReset">
