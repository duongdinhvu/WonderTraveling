                            ...
                            <tbody>
                                <c:forEach items="${requestScope.cars}" var="car" varStatus="stt">
                                    <tr  align="center">
                                        ...
                                        <td style="font-weight: bold">${car.carName}</td>
                                        <td style="font-weight: bold">${car.carID}</td>
                                        <td><img style="width: 180px;height: 100px" src="${car.carImage}"/></td>


                                        <c:if test="${car.carTrasmission == 'automatic'}"><td><span class="label label-white middle">Automatic</span></td></c:if>
                                        <c:if test="${car.carTrasmission == 'manual'}"><td><span class="label label-warning label-white middle">Manual</span></td></c:if>

                                            <td>${car.carSeats}</td>


                                        <c:if test="${car.carAirConditioning eq true}"><td><span class="label label-warning label-white middle">Yes</span></td></c:if>
                                        <c:if test="${car.carAirConditioning eq false}"><td><span class="label label-white middle">No</span></td></c:if>




                                            <td style="width: 60px;">${car.carPrice}$</td>
                                        ...
                                        <c:if test="${car.carStatus eq true}"><td><span class="label label-success arrowed">Available</span></td></c:if>
                                        <c:if test="${car.carStatus eq false}"><td><span class="label label-inverse">Disable</span></td></c:if>

                                            <td>
                                                <div class="inline pos-rel">                                                     
                                                    <form action="adminCarEditController" method="post">
                                        ...
                                        <c:if test="${car.carPushChair eq true}"><td><span class="label label-warning label-white middle">Yes</span></td></c:if>
                                        <c:if test="${car.carPushChair eq false}"><td><span class="label label-white middle">No</span></td></c:if>                                      

                                            <td>${car.carDoors}</td>

                                        <c:if test="${car.carGPS eq true}"><td><span class="label label-warning label-white middle">Yes</span></td></c:if>
                                        <c:if test="${car.carGPS eq false}"><td><span class="label label-white middle">No</span></td></c:if>
