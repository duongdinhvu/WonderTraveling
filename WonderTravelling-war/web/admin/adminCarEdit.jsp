                ...
                <div class="main-content-inner">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal" role="form" action="adminCarEditController" method="post" onsubmit="return valid();">

                                <div class="form-group">                          
                                    <div class="col-sm-9">
                                        <input data-rel="tooltip" type="hidden" id="form-field-6" readonly="true" name="txtCarID" value="${id.carID}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input data-rel="tooltip" type="text" id="form-field-6"  data-placement="bottom" name="txtCarName"
                                               required="true" pattern="[a-zA-Z0-9\s]{3,50}" oninvalid="this.setCustomValidity('Car Name must be in range between 3-50 words !')" 
                                               oninput="setCustomValidity('')" title="Car Name" value="${id.carName}" />
                                ...
                                <div class="form-group">                                     
                                    <div class="control-group">
                                        ...
                                        <div class="col-sm-9 radio">
                                            <label>
                                                <input name="radGPS" type="radio" class="ace" value="true"
                                                       <c:if test="${id.carGPS=='true'}">checked</c:if> />
                                                       <span class="col-xs-10 col-sm-5 lbl">Yes</span>
                                                </label>
                                                <label>
                                                    <input name="radGPS" type="radio" class="ace" value="false"
                                                    <c:if test="${id.carGPS=='false'}">checked</c:if> />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input data-rel="tooltip" type="number" id="form-field-6" min="1" max="999" title="Giá" data-placement="bottom"
                                                   step="0.001" required="true" oninvalid="this.setCustomValidity('Price must be in range $1-999 !')" 
                                                   oninput="setCustomValidity('')" title="Price" name="txtPrice" 
                                                   value="${id.carPrice}" />
                                ...
                                <div class="form-group">                                     
                                        ...
                                        <div class="col-sm-9 radio">
                                            <label>
                                                <input name="radChair" type="radio" class="ace" value="true" 
                                                       <c:if test="${id.carPushChair=='true'}">checked</c:if> />
                                                       <span class="col-xs-10 col-sm-5 lbl">Yes</span>
                                                </label>
                                                <label>
                                                    <input name="radChair" type="radio" class="ace" value="false" 
                                                    <c:if test="${id.carPushChair=='false'}">checked</c:if> />
                                                    <span class="col-xs-10 col-sm-5 lbl">No</span>
                                                </label>
                                            </div>
                                        </div>                                       
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input style="width: 320px;height: 200" type="image" id="form-field-6" data-placement="bottom"  src="${id.carImage}" disabled="true" value="${id.carImage}" />
                                        <input data-rel="tooltip" type="hidden" id="form-field-6" readonly="true" name="imgCarImage" value="${id.carImage}" />
                                    </div>
                                </div>


                                <div class="form-group"> 
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Choose Another Image </label>
                                    <div class="col-sm-4">
                                        <div class="widget-box">
                                            <div class="widget-body">
                                                <div class="widget-main">                                                     
                                                    <div class="form-group">
                                                        <div class="col-xs-12">
                                                            <input  type="file" id="id-input-file-3" accept="image/*" name="txtCarImage"  src="${id.carImage}" value="${id.carImage}" onchange="PreviewImage();" />

                                                            <input type="text" id="txtImg" style="height: max-content; width: 400px; border: 0" readonly="true" />
                                                            <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Image Only !" title="Warning !">!</span>
                                                        </div>
                                ...
                                <div class="form-group">                                     
                                    <div class="control-group">
                                        ...
                                        <div class="col-sm-9 radio">
                                            <label>
                                                <input name="radAir" type="radio" class="ace" value="true" 
                                                       <c:if test="${id.carAirConditioning=='true'}">checked</c:if> />
                                                       <span class="col-xs-10 col-sm-5 lbl">Yes</span>
                                                </label>
                                                <label>
                                                    <input name="radAir" type="radio" class="ace" value="false" 
                                                    <c:if test="${id.carAirConditioning=='false'}">checked</c:if> />
                                                    <span class="col-xs-10 col-sm-5 lbl">No</span>
                                                </label>
                                            </div>
                                        </div>                                       
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-10 col-sm-5 lbl">
                                                            <div class="knob-container inline">
                                                                <input  type="text" class="input-small knob" value="${id.carSeats}" name="txtSeat" data-min="2" data-max="50" data-width="120" data-height="120" data-thickness=".2" data-fgcolor="#87B87F" data-displayprevious="true" data-anglearc="250" data-angleoffset="-125" />
                                                        </div>
                                                    </div>
                                                </div>                                           
                                            </div>
                                ...
                                <div class="form-group">                                     
                                    <div class="control-group">
                                        ...
                                        <div class="col-sm-9 radio">
                                            <label>
                                                <input name="radTrans" type="radio" class="ace" value="automatic" 
                                                       <c:if test="${id.carTrasmission=='automatic'}">checked</c:if> />
                                                       <span class="col-xs-10 col-sm-5 lbl">Automatic</span>
                                                </label>
                                                <label>
                                                    <input name="radTrans" type="radio" class="ace" value="manual" 
                                                    <c:if test="${id.carTrasmission=='manual'}">checked</c:if> />
                                            ...
                                            <div class="widget-main">
                                                <div class="control-group">
                                                    <div class="row">
                                                        <div class="col-xs-10 col-sm-5 lbl">
                                                            <div class="knob-container inline">
                                                                <input type="text" class="input-small knob" value="${id.carDoors}" name="txtDoor" data-min="1" data-max="4" data-width="120" data-height="120" data-thickness=".2" data-fgcolor="#87B87F" data-displayprevious="true" data-anglearc="250" data-angleoffset="-125" />
                                                        </div>
                                                    </div>
                                                </div>                                           
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input data-rel="tooltip" type="text" id="form-field-6" value="${id.licensePlate}" data-placement="bottom" name="txtCarLic" title="License Plate"  required="true" 
                                               pattern="[a-zA-Z0-9\s]{7,50}"  oninvalid="this.setCustomValidity('License Plate must be in range between 7-50 words !')" 
                                        ...
                                        <div class="col-sm-9 radio">
                                            <label>
                                                <input name="radStatus" type="radio" class="ace" value="true" 
                                                       <c:if test="${id.carStatus=='true'}">checked</c:if> />
                                                       <span class="col-xs-10 col-sm-5 lbl">Available</span>
                                                </label>
                                                <label>
                                                    <input name="radStatus" type="radio" class="ace" value="false" 
                                                    <c:if test="${id.carStatus=='false'}">checked</c:if> />
                                ...
                                <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">                                                           
                                        &nbsp; &nbsp; &nbsp;  
                                        <button class="btn btn-info" type="submit" name="action" value="update" onclick="return confirm('Confirm Update ?')">
