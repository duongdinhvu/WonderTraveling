                                ...
                                <table class="table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 120px; text-align: center; height: 35px;">Numbers of Car Booked</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${requestScope.list}" var="car" varStatus="num">
                                            <tr style="height: 30px;">
                                                ...
                                                <td style="width: 120px; text-align: center;">${car.numOfBooked}</td>
                                            </tr>
                                        </c:forEach>
                                        <tr>
                                            <td colspan="4">
                    ...
                    <div style="width: 1025px;">
                        <div style="margin-left: 10px;">
                            <form action="AdminCar_ReportTour_FilePDF_Controller" method="get">
                                ...
                                <button name="action" value="btnPrintTop05Car" type="submit" style="margin-left: 900px; width: 100px; height: 25px; color: #ffffff;" class="btn-info">Print</button>
                            </form>
