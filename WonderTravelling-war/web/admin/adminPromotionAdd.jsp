        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <form class="form-horizontal" id="form" name="form" role="form" action="adminPromotionAddController" method="post" onsubmit="return valid();" >                       

                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Promotion Code </label>

                            <div class="col-sm-9">
                                <input data-rel="tooltip" type="text" id="form-field-6" data-placement="bottom" name="txtProCode" required="true" pattern="[a-zA-Z0-9\s]{5,20}"
                        ...
                        <div class="form-group">
                            ...
                            <input style="width: 190px; height: 27px; text-align: center; border: 1px black solid; border-bottom-left-radius: 7px; border-bottom-right-radius: 7px; border-top-left-radius: 7px; border-top-right-radius: 7px;"
                                   type="text" id="staDate" name="txtStartDate" placeholder="Select Start Date: " required="true" value="">
                        ...
                        <div class="form-group">
                            ...
                            &nbsp;&nbsp;
                            <input style="width: 190px; height: 27px; text-align: center; border: 1px black solid; border-bottom-left-radius: 7px; border-bottom-right-radius: 7px; border-top-left-radius: 7px; border-top-right-radius: 7px;"
                                   type="text" id="endDate" name="txtEndDate" placeholder="Select End Date: " required="true" value="">
                            <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Required !" title="Warning !">!</span>
                            <br />
                        </div>
                    ...
                    <script >
                                    function valid() {
                                        var x = confirm('Are You Sure You Want To Create This Promotion ?');
                                        if (x) {
                ...
                var date2 = $('#staDate').datepicker('getDate');
                            date2.setDate(date2.getDate() + 1);
                                ...
                                dateFormat: "dd-mm-yy",
                                    onClose: function() {
                                    var staDate = $('#staDate').datepicker('getDate');
                                console.log(dt1);
                    ...
                    <script type="text/javascript">
                                        jQuery(function($) {                             $('#id-disable-check').on('click', function() {
                            ...
                            .on('resize.chosen', function() {
                                ...
                                var $this = $(this);
                                    ...
                                    $('#chosen-multiple-style .btn').on('click', function(e) {
                                        var target = $(this).find('input[type=radio]');                                     var which = parseInt(target.val());
                                    if (which == 2)
