        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <!------------------------------------------------ PAGE CONTENT BEGINS ------------------------------------------->
                    <div id="TabPanel" style="width: 1030px; margin-left: 50px;">	
                        ...
                        <div class="tab-content clearfix" style="width: 1030px;">
                            ...
                            <div class="tab-pane active" id="PendingList">
                                <p id="textSearchError" style="color: red; margin-left: 610px;"></p>
                                <form action="AdminTour_SearchTourBooked_Controller" method="post">
                                    <div style="margin-left: 480px; margin-bottom: 20px;">
                                        ...
                                        <button style="width: 80px; margin-left: 15px; height: 30px; font-size: 14px;" type="submit" name="action"
                                                value="SearchPending" onclick="return validPending()">
                                            <i class="fa fa-search"> Search</i>
                                        </button>
                                        <button style="width: 80px; margin-left: 20px; height: 30px; font-size: 14px;" type="submit" name="action" value="Reload">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <th style="width: 150px;">Group/Not Group</th>
                                        ...
                                        <tbody id="table_Pending">
                                            <c:forEach items="${requestScope.PendingList}" var="item">
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        <c:if test="${item.ISGroup eq true}">
                                                            ${item.customerID.customerID}
                                                        </c:if>
                                                    </td>
                                                    <td style="text-align: center">${item.numberOfPeople}</td>
                                                    <td style="text-align: center;">
                                                        <c:if test="${item.ISGroup eq true}"><img src="assets/images/Users-Group-icon.png"/></c:if>
                                                        <c:if test="${item.ISGroup eq false}"><img src="assets/images/user-icon-32.png"/></c:if>
                                                        </td>

                                                        <td style="width: 50px;">
                                                        <c:if test="${item.ISGroup eq true}">
                                                            <form action="AdminTour_GroupTourReserver_DetailEdit_Controller" method="post">
                                                                <input type="hidden" name="txtTourBookedID_Pending" value="${item.tourBookedID}"/>
                                                                <button type="submit" name="action" style="width: 70px; font-size: 14px;" class="btn-app" value="btnDetail_Pending">Detail</button>
                                                            </form>
                                                        </c:if>
                                                        <c:if test="${item.ISGroup eq false}">
                                                    ...
                                                    <td style="width: 50px;">
                                                        <c:if test="${item.ISGroup eq true}">
                                                            <form action="AdminTour_GroupTourReserver_DetailEdit_Controller" method="post">
                                                                <input type="hidden" name="txtTourBookedID_Edit_Pending" value="${item.tourBookedID}"/>
                                                                <button type="submit" style="width: 70px; font-size: 14px;" class="btn-warning" name="action" value="btnEdit_Pending_Link">Edit</button>
                                                            </form>
                                                        </c:if>
                                                    ...
                                                    <td style="width: 50px;">
                                                        <c:if test="${item.ISGroup eq true}">
                                                            <form action="AdminTour_GroupTourReserver_DetailEdit_Controller" method="post">
                                                                <input type="hidden" name="txtTourBookedID_Cancel_Pending" value="${item.tourBookedID}"/>
                                                                <button style="width: 70px; font-size: 14px;" class="btn-success" type="submit" name="action" value="btnCancelTourBooked_Pending"
                                ...
                                <form action="AdminTour_SearchTourBooked_Controller" method="post">
                                    <div style="margin-left: 480px; margin-bottom: 20px;">
                                        ...
                                        <button style="width: 80px; margin-left: 15px; height: 30px; font-size: 14px;"
                                                type="submit" name="action" value="SearchDeparting" onclick="return validDeparting()">
                                            <i class="fa fa-search"> Search</i>
                                        </button>
                                        <button style="width: 80px; margin-left: 20px; height: 30px; font-size: 14px;" type="submit" name="action" value="Reload">
                                            <i class="fa fa-repeat"> Reload</i>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody id="table_Departing">
                                            <c:forEach items="${requestScope.DepartingList}" var="item">
                                                <tr>
                                                    <td style="text-align: center">${item.tourBookedID}</td>
                                                    <td style="text-align: center">${item.tourID.tourID}</td>
                                                    <td style="text-align: center">
                                                        <fmt:formatDate value="${item.departureDate}" pattern="dd-MM-yyyy" /> 
                                                    </td>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <c:if test="${item.ISGroup eq true}">
                                                            <form action="AdminTour_GroupTourReserver_DetailEdit_Controller" method="post">
                                                                <input type="hidden" name="txtTourBookedID_Departing" value="${item.tourBookedID}"/>
                                                                <button style="width: 70px; font-size: 14px;" class="btn-app" type="submit" name="action" value="btnDetail_Departing">Detail</button>
                                                            </form>
                                                        </c:if>
                            ...
                            <div class="tab-pane" id="CompletedList">
                                ...
                                <form action="AdminTour_SearchTourBooked_Controller" method="post">
                                    <div style="margin-left: 480px; margin-bottom: 20px;">
                                        ...
                                        <input style=" margin-left: 15px; height: 30px;" type="text" name="txtSearch" id="txtSearchCompleted" placeholder="Enter Search Text..."/>
                                        <button style="width: 80px; margin-left: 15px; height: 30px; font-size: 14px;"
                                                type="submit" name="action" value="SearchCompleted" onclick="return validCompleted();">
                                            <i class="fa fa-search"> Search</i>
                                        </button>
                                        <button style="width: 80px; margin-left: 20px; height: 30px; font-size: 14px;" type="submit" name="action" value="Reload">
                                            <i class="fa fa-repeat"> Reload</i>
                                            ...
                                            <c:forEach items="${requestScope.CompletedList}" var="item">
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <c:if test="${item.ISGroup eq true}">
                                                            <form action="AdminTour_GroupTourReserver_DetailEdit_Controller" method="post">
                                                                <input type="hidden" name="txtTourBookedID_Completed" value="${item.tourBookedID}"/>
                                                                <button type="submit" style="width: 70px; font-size: 14px;" class="btn-app" name="action" value="btnDetail_Completed">Detail</button>
                                                            </form> 
                                                        </c:if>
                                                        ...
                                                        <c:if test="${item.ISGroup eq false}">
                                                            <form action="AdminTour_OddTourReserved_DetailEdit_Controller" method="post">
                                                                <input type="hidden" name="txtTourBookedID_Completed" value="${item.tourBookedID}"/>
                                                                <button style="width: 70px; font-size: 14px;" class="btn-app" type="submit" name="action" value="btnDetail_Completed">Detail</button>
                                                            </form>
                                                        </c:if>
                                                    </td>
                                                </tr>
                                ...
                                <form action="AdminTour_SearchTourBooked_Controller" method="post">
                                    <div style="margin-left: 480px; margin-bottom: 20px;">
                                        ...
                                        <button style="width: 80px; margin-left: 15px; height: 30px; font-size: 14px;" type="submit"
                                                name="action" value="SearchCancel" onclick="return validCancel()">
                                            <i class="fa fa-search"> Search</i>
                                        </button>
                                        <button style="width: 80px; margin-left: 20px; height: 30px; font-size: 14px;" type="submit" name="action" value="Reload">
                                            <i class="fa fa-repeat"> Reload</i>
                                            ...
                                            <c:forEach items="${requestScope.CancelList}" var="item">
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <c:if test="${item.ISGroup eq true}">
                                                            <form action="AdminTour_GroupTourReserver_DetailEdit_Controller" method="post">
                                                                <input type="hidden" name="txtTourBookedID_Cancel" value="${item.tourBookedID}"/>
                                                                <button style="width: 70px; font-size: 14px;" class="btn-app" type="submit" name="action" value="btnDetail_Cancel">Detail</button>
                                                            </form>
                                                        </c:if>
