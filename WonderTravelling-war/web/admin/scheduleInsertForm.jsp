    ...
    <head>
        ...
        <script>
            function validateForm() {
                var scheduleTitle = document.formCreateSchedule.txtScheduleTitle.value;
                var image = document.formCreateSchedule.txtImage_Insert_Extra.value;
                var content = document.formCreateSchedule.txtAreaContent.value;
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="container" style="width: 1025px;">
                        <form action="AdminTour_ScheduleInsert_Controller" method="post" name="formCreateSchedule" onsubmit="return validateForm()">
                            <input type="hidden" name="maxSchedule" value="${requestScope.maxSchedule}"/>
                            <input type="hidden" id="isCompleted" name="isCompleted" value="${requestScope.isCompleted}"/>
                            <center>
                                <label style="margin-top: 10px; font-size: 30px; color: #00BE67; text-align: center">
                                    ${requestScope.tourTitle}
                                    <input type="hidden" name="txtTourTitle" value="${requestScope.tourTitle}"/>
                            ...
                            <div style="width: 1000px; height: auto; border: 1px solid; margin-left: 5px; margin-top: 25px;" class="well">
                                <div style="margin-left: 5px;">
                                    <b><input style="text-align: center;" name="txtDayTitle" value="${requestScope.dayTitles}" type="hidden" readonly="true"/></b>
                                ...
                                <input id="txtScheduleTitle" name="txtScheduleTitle" style="width: 400px;" type="text">
                                <span id="scheduleError" style="color: red;"></span>
                                <br/><br/>
                                ...
                                <div>
                                    <div style="width: 110px; margin-left: 50px; margin-top: 20px; font-size: 14px; font-weight: bold;">Content:</div>
                                    <span id="contentError" style="color: red;"></span>
                                    <br/>
                                    <textarea id="txtAreaContent" name="txtAreaContent" style="width: 975px; height: 350px; overflow: scroll; resize: none;"></textarea><br/><br/>

                                </div>
                                <div>
                                    <center>
                                        <button name="action" value="btnCreateSchedule" type="submit" class="btn-info" style="margin-top: 30px; width: 100px; font-weight: bolder; font-size: 14px;" onclick="return isValid()">
                                            <i class="fa fa-plus-circle"> Create</i>
                                        </button>

                                        <button type="button" style="margin-left: 70px; width: 100px; font-size: 14px;" onclick="resetForm();">
                        ...
                        <form action="AdminTour_TourSelect_Controller" method="post">
                            <center>
                                <button class="btn-danger" type="submit" name="action" value="btnCompletedTour" style="width: 100px; height: 25px; font-size: 14px;">
                                    <i class="fa fa-archive"> Cancel</i>
                                </button>
                            </center>
                        </form>        
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <center>
                                        <h4 class="modal-title" style="color: #0092ef;">Completed Create Tour</h4>
                                        <img src="assets/images/tick.png" style="width: 100px; height: 50px; margin-top: 20px;"/>
                                    </center>
                                </div>
                                ...
                                <div class="modal-footer">                        
                                    <center>
                                        <form action="AdminTour_TourSelect_Controller" method="post">                                                        
                                            <button type="submit" name="action" style="width: 100px;" class="btn btn-info">OK</button>
                                        </form>
                                    </center>
                                </div>
                            </div>
