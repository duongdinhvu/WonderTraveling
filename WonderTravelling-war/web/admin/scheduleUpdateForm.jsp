            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="container" style="width: 900px;">
                        <div style="width: 400px; margin-top: 10px; margin-left: auto; margin-right: auto; font-size: 25px; color: #00BE67; text-align: center">
                            <span>${requestScope.tour.tourTitle}</span>
                        </div><br/><br/>
                        <table border="1" class="table table-striped">
                            <thead>
                            <th style="width: 150px; font-size: 14px;">Title</th>
                            <th style="width: 250px; font-size: 14px;">Image</th>
                            <th style="width: 350px; font-size: 14px;">Content</th>
                            <th style="width: 100px;"></th>
                            </thead>
                            <tbody>
                                <c:forEach items="${requestScope.listSchedule}" var="schedule">
                                    <tr>
                                        <td style="width: 150px; font-weight: bold;">${schedule.summary}</td>
                                        <td style="width: 250px; height: 150px;"><input style="width: 250px; height: 150px;" type="image" src="assets/images/${schedule.image1}"/></td>
                                        <td style="width: 350px;">${schedule.content}</td>
                                        <td style="width: 100px;">                                            
                                            <form action="AdminTour_Schedule_Add_Update_Delete_Extra_Controller" method="post">
                                                ...
                                                <input type="hidden" name="txtScheduleIDUpdate" value="${schedule.scheduleID}"/>
                                                <button style="font-size: 14px;" class="btn-info" type="submit" name="action" value="btnUpdateSchedule_Link">
                        ...
                        <div style="height: 100px;" class="well">
                            <center>
                                <form action="AdminTour_Schedule_Add_Update_Delete_Extra_Controller" method="post">
                                    <input type="hidden" name="txtTourID_Extra" value="${requestScope.tourID}"/>
                                    <c:if test="${requestScope.isEnoughOfSchedule eq 1}">
                                        <button class="btn-danger" style="font-size: 14px;" type="button" disabled="true">Full Of Schedule</button>
                                    </c:if>

                                    <c:if test="${requestScope.isEnoughOfSchedule eq 0}">
                                        <button class="btn-success" style="font-size: 14px;" type="submit" name="action" value="btnCreateSchedule_Extra_Link">Add Schedule</button>
                                    </c:if>
                                    <!--<button class="btn-success" style="font-size: 14px;" type="submit" name="action" value="btnCreateSchedule_Extra_Link">Add Schedule</button>-->
                                    <button style="margin-left: 747px; margin-top: 20px; width: 100px; font-size: 14px;" class="btn-success" name="action" type="submit" value="btnBack_scheduleUpdateForm">Back</button>
                                </form> 
                            </center>                
                        </div>
                    </div>
